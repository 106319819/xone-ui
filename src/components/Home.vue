    ...
    <el-col :span="24" class="topbar-wrap">
      ...
      <div class="topbar-account topbar-btn">
        <el-dropdown trigger="click">
          <span class="el-dropdown-link userinfo-inner"><i class="iconfont icon-gerentouxiang_o"></i> {{nickname}}  <i
    ...
    <el-col :span="24" class="main">
      ...
      <aside :class="{showSidebar:!collapsed}">
        ...
        <div class="menu-toggle" @click.prevent="collapse">
          <i class="iconfont icon-jiantou_yemian_xiangzuo_o" v-show="!collapsed"></i>
          <i class="iconfont icon-jiantou_yemian_xiangyou_o" v-show="collapsed"></i>
        </div>
        <!--导航菜单-->
